...
import com.baoluo.community.ui.AtyEventSend;
import com.baoluo.community.ui.AtyHumorSendNew;
...
public class MoreWindow extends PopupWindow implements OnClickListener {
	...
	public MoreWindow(Activity context) {
		...
		soundPool.load(mContext, R.raw.composer_open, 1);
		soundPool.load(mContext, R.raw.composer_close, 2);
	}
	...
	public void onClick(View v) {
		...
		case R.id.more_window_local:
			i.setClass(mContext, AtyHumorSendNew.class);
			break;
		case R.id.more_window_online:
			i.setClass(mContext, AtyEventSend.class);
			break;
		case R.id.more_window_delete:
			i.setClass(mContext, PublishTopicActivity.class);
			break;
		}
