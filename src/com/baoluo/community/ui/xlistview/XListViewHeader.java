package com.baoluo.community.ui.xlistview;
...
import com.baoluo.im.gif.GifView;
/**
 * 下拉刷新
 * @author Ryan_Fu
 *  2015-5-15
...
//		mProgressBar = (ProgressBar) findViewById(R.id.xlistview_header_progressbar);
		gif = (GifView) findViewById(R.id.header_gifview);
	...
	public void setState(int state) {
		...
		if (state == STATE_REFRESHING) { // 显示进度
			...
			gif.setVisibility(View.VISIBLE);// 显示进度条
		} else { // 显示箭头图片
