...
import com.baoluo.community.util.ImageLoader;
import com.baoluo.community.util.ImageLoader.Type;
...
public class ViewHolder {
	 ...
	 * @return
	 */
	public ViewHolder setNetImageByUrl(int viewId, String url) {
		GlobalContext.options.shouldShowImageOnFail();
		GlobalContext.getInstance().imageLoader.displayImage(url,
				(ImageView) getView(viewId), GlobalContext.options, null);
		return this;
	}
